...
public class GETActivity extends AppCompatActivity {
    ...
    private void init() {
        mVerticalViewPager = findViewById(R.id.vvp_main);
        ...
        mVerticalViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int i) {
                if (i != 1) {
                    mVerticalViewPager.setCurrentItem(1);
                    if (i == 0) {
                        Toast.makeText(GETActivity.this, "刷新成功!", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(GETActivity.this, "退出!", Toast.LENGTH_SHORT).show();
                    }
                }
            }
